...
export const ROUTE_ACCESS_RULES: RouteAccessRule[] = [
  ...
  { pattern: "/settings", permission: "company_config.view" },
  { pattern: "/settings/order-status", permission: "company_config.manage" },
  { pattern: "/settings/roles", permission: "role.manage" },
  { pattern: "/branches", permission: "branch.view" },
  { pattern: "/branches/create", permission: "branch.manage" },
  { pattern: "/branches/:branchId/edit", permission: "branch.manage" },
